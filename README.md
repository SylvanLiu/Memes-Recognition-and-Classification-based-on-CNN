...
It was proposed merely for my personal interest, partially implemented by local python scripts for data processing and pre-processing, and then deployed on Aliyun online PAI machine learning platform with online configuration files for training and predicting. *Some modules in this repository are not highly completed, and please keep in mind that everything of this project was merely an immature attempt for learning/attaining my primary design.*
